...
<img src="images/02/windows安全性.png" width="480" alt="windows安全性" />
...
<img src="images/02/id示意.jpg" width="480" alt="id示意" />
...
<img src="images/02/sid示例.png" width="480" alt="sid示例" />
...
<img src="images/02/安全标识符结构.png" width="480" alt="安全标识符结构" />
...
####  2.1.1 本地安全主体（本地用户帐户和安全组）

- 在本地计算机上创建, 用于实现本地资源的访问控制。
- 由本地计算机上的安全帐户管理器 (SAM) 管理。

####  2.1.2 域中创建的安全主体（ActiveDirectory 对象）
...
<img src="images/02/windows授权与访问控制过程.png" width="480" alt="windows授权与访问控制过程" />
...
####  2.2.3 安全描述符和 访问控制列表（ Access Control Lists，ACL）
...
<img src="images/02/sid01.png" width="480" alt="sid01" />

也可以使用命令```get-acl```，在命令行查看：

<img src="images/02/安全描述符.png" width="480" alt="安全描述符" />
...
<img src="images/02/权限示例.png" width="480" alt="权限示例" />


---

####  2.2.5 身份验证中的安全上下文（Security context in authentication）
...
###  2.3 账户和安全组（Accounts and security groups)
...
###  3.1 默认本地用户账户（Default local user accounts）

默认本地用户帐户是内置帐户, 这些帐户是在安装 Windows 时自动创建的。

安装 Windows 后, 不能删除或删除默认本地用户帐户。

<img src="images/02/trydeleteadmin.png" width="480" alt="trydeleteadmin" />
...
###  3.2 默认本地系统帐户（Default local system accounts）
...
<img src="images/02/systemaccount.png" width="480" alt="systemaccount" />

<img src="images/02/SYSTEM账户.png" width="480" alt="SYSTEM账户" />

注意：Administor与SYSTEM不是一种用户。

---

####  3.2.2 NETWORK SERVICE 账户

NETWORK SERVICE 账户是个Windows 预定义本地系统账户，它由服务控制管理器 (SCM) 使用。

使用NETWORK SERVICE 账户运行的某个服务，可向远程服务器展示当前计算机的凭据。 

<img src="images/02/networkservice账户.png" width="480" alt="networkservice账户" />

---

####  3.2.3 LOCAL SERVICE 账户

LOCAL SERVICE 账户也是一个预定义的本地账户，它用于服务控制管理器。

LOCAL SERVICE 账户具有访问呢本地计算机（windows）的最低权限, 在网络上显示为匿名凭据。 

<img src="images/02/localservice账户.png" width="480" alt="localservice账户" />
...
####  3.3.2 强制执行远程访问的本地帐户限制

UAC 在程序需要执行管理员权限的操作时通知用户。可以使用命令```uac```，查看。

<img src="images/02/uac01.png" width="480" alt="uac01" />
...
##  9 用户账户控制（User Account Control, UAC)
...
<img src="images/02/管理员用户与标准用户的不同.png" width="480" alt="管理员用户与标准用户的不同" />
...
<img src="images/02/windowsuser许可提示.gif" width="480" alt="windowsuser许可提示" />
...
<img src="images/02/windowsuser许可提示2.gif" width="480" alt="windowsuser许可提示2" />
...
<img src="images/02/uacarchitecture.gif" width="480" alt="uacarchitecture" />
...
<img src="images/02/uac策略.png" width="480" alt="uac策略" />
...
<img src="images/02/wfasdomainisoboundary.gif" width="480" alt="wfasdomainisoboundary" />
...
<img src="images/02/ad存储结构.png" width="480" alt="ad存储结构" />
...
<img src="images/02/ADdatastorearch.gif" width="480" alt="ADdatastorearch" />
...
####  13.2.1 Microsoft 安全支持提供程序接口 (SSPI) 
...
####  13.2.3 Windows 认证中的凭据处理过程（ Credentials Processes）
...
####  13.2.4 Local Security Authority
