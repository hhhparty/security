...
在IDA pro 中，将鼠标移到IDA pro识别出的函数参数处，例如下面的argc等：

<img src="images/idapro/idapro-function.png">

双击上面的argc 等函数参数名，ida pro会进入stack of function-name 的栈帧视图
